...
def build_allele_frequency_table(
    *,
    ...
    friendly_names = {
        "chrom": _("Chromosome"),
        "pos": _("Position (bp)"),
        "ref": _("Reference allele"),
        "alt": _("Alternate allele"),
        "qual": _("QUAL"),
        "filter": _("Filter status"),
        "info__af": _("Allele frequency (AF)"),
        "info__ac": _("Allele count (AC)"),
        "info__an": _("Alleles analysed (AN)"),
        "info__dp": _("Read depth (DP)"),
        "info__mq": _("Mapping quality (MQ)"),
        "info__qd": _("Quality by depth (QD)"),
        "info__fs": _("Fisher strand (FS)"),
        "info__sor": _("Strand odds ratio (SOR)"),
        "info__ns": _("Samples counted (NS)"),
        "info__sb": _("Strand bias (SB)"),
        "variant_id": _("Variant ID"),
        "comments": _("Variant comments"),
        "sample_group__name": _("Sample group"),
        "sample_group__source_lab": _("Source laboratory"),
        "sample_group__doi": _("DOI"),
        "sample_group__contact_email": _("Contact email"),
        "sample_group__contact_phone": _("Contact phone"),
        "sample_group__total_samples": _("Total samples"),
        "sample_group__inclusion_criteria": _("Inclusion criteria"),
        "sample_group__exclusion_criteria": _("Exclusion criteria"),
        "sample_group__comments": _("Group comments"),
        "sample_group__reference_genome_build__build_name": _("Reference build"),
        "sample_group__reference_genome_build__build_version": _("Reference build version"),
        "sample_group__genome_complexity__size": _("Genome size"),
        "sample_group__genome_complexity__ploidy": _("Genome ploidy"),
        "sample_group__genome_complexity__gc_content": _("Genome GC content"),
        "sample_group__sample_origin__tissue": _("Sample tissue"),
        "sample_group__sample_origin__collection_method": _("Collection method"),
        "sample_group__sample_origin__storage_conditions": _("Storage conditions"),
        "sample_group__sample_origin__time_stored": _("Time stored"),
        "sample_group__material_type__material_type": _("Material type"),
        "sample_group__material_type__integrity_number": _("Integrity number"),
        "sample_group__library_construction__kit": _("Library kit"),
        "sample_group__library_construction__fragmentation": _("Fragmentation"),
        "sample_group__library_construction__adapter_ligation_efficiency": _("Adapter ligation efficiency"),
        "sample_group__library_construction__pcr_cycles": _("PCR cycles"),
        "sample_group__illumina_seq__instrument": _("Illumina instrument"),
        "sample_group__illumina_seq__flow_cell": _("Illumina flow cell"),
        "sample_group__illumina_seq__channel_method": _("Illumina channel method"),
        "sample_group__illumina_seq__cluster_density": _("Illumina cluster density"),
        "sample_group__illumina_seq__qc_software": _("Illumina QC software"),
        "sample_group__ont_seq__instrument": _("ONT instrument"),
        "sample_group__ont_seq__flow_cell": _("ONT flow cell"),
        "sample_group__ont_seq__flow_cell_version": _("ONT flow cell version"),
        "sample_group__ont_seq__pore_type": _("ONT pore type"),
        "sample_group__ont_seq__bias_voltage": _("ONT bias voltage"),
        "sample_group__pacbio_seq__instrument": _("PacBio instrument"),
        "sample_group__pacbio_seq__flow_cell": _("PacBio flow cell"),
        "sample_group__pacbio_seq__smrt_cell_type": _("PacBio SMRT cell type"),
        "sample_group__pacbio_seq__zmw_density": _("PacBio ZMW density"),
        "sample_group__iontorrent_seq__instrument": _("Ion Torrent instrument"),
        "sample_group__iontorrent_seq__flow_cell": _("Ion Torrent flow cell"),
        "sample_group__iontorrent_seq__chip_type": _("Ion Torrent chip type"),
        "sample_group__iontorrent_seq__ph_calibration": _("Ion Torrent pH calibration"),
        "sample_group__iontorrent_seq__flow_order": _("Ion Torrent flow order"),
        "sample_group__iontorrent_seq__ion_sphere_metrics": _("Ion Sphere metrics"),
        "sample_group__bioinfo_alignment__tool": _("Alignment tool"),
        "sample_group__bioinfo_alignment__params": _("Alignment parameters"),
        "sample_group__bioinfo_alignment__ref_genome_version": _("Reference genome version"),
        "sample_group__bioinfo_alignment__recalibration_settings": _("Recalibration settings"),
        "sample_group__bioinfo_variant_calling__tool": _("Variant calling tool"),
        "sample_group__bioinfo_variant_calling__version": _("Variant caller version"),
        "sample_group__bioinfo_variant_calling__filtering_thresholds": _("Variant filtering thresholds"),
        "sample_group__bioinfo_variant_calling__duplicate_handling": _("Duplicate handling"),
        "sample_group__bioinfo_variant_calling__mq": _("Variant caller MQ"),
        "sample_group__bioinfo_post_proc__normalization": _("Post-processing normalization"),
        "sample_group__bioinfo_post_proc__harmonization": _("Post-processing harmonization"),
        "sample_group__input_quality__a260_a280": _("Input A260/A280"),
        "sample_group__input_quality__a260_a230": _("Input A260/A230"),
        "sample_group__input_quality__dna_concentration": _("DNA concentration"),
        "sample_group__input_quality__rna_concentration": _("RNA concentration"),
        "sample_group__input_quality__notes": _("Input quality notes"),
    }
